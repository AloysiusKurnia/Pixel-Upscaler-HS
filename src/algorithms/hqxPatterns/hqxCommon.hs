module Src.Algorithms.HQXPatterns.HQXCommon where
...
----- HQX Interpolation patterns from given neighbor -----
hqxGetPattern :: Square3x3 RGBPixel -> Int
hqxGetPattern (c1, c2, c3, c4, c5, c6, c7, c8, c9) =
